          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/beaches/saunders-beach" className="text-muted-foreground hover:text-primary transition-colors">Saunders Beach</Link></li>
              </ul>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/pallarenda-beach" className="hover:text-primary transition-colors">Pallarenda Beach</Link></li>
              <li><Link to="/beaches/saunders-beach" className="hover:text-primary transition-colors">Saunders Beach</Link></li>
              ...
              <li><Link to="/townsville-airport" className="hover:text-primary transition-colors">Airport &amp; Flights</Link></li>
              <li><Link to="/local-tips" className="hover:text-primary transition-colors">Local Tips</Link></li>
              <li><Link to="/guides/magnetic-island-day-trip" className="hover:text-primary transition-colors">Magnetic Island Day Trip</Link></li>
              ...
              <li><Link to="/suburbs" className="hover:text-primary transition-colors">Suburbs Guide</Link></li>
