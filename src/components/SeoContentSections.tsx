...
const SeoContentSections = () => {
  const sections = [
    ...
    },
    {
      ...
      content: "Townsville is one of Queensland's most dog-friendly cities. Rowes Bay Dog Park offers a large fenced off-leash area near the beach, perfect for running and socialising. The Strand has designated dog-friendly zones along the foreshore, ideal for sunrise and sunset walks. Popular pet-friendly cafés include Juliette's Gelateria on The Strand, which provides water bowls and outdoor seating, and The Courtyard, a trendy spot with shaded tables welcoming four-legged friends.",
