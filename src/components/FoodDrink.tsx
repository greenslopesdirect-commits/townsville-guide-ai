...
// 1. ADD THE NECESSARY IMPORT for your local file
...
const FoodDrink = () => {
  const restaurants = [
    ...
    },
    {
      ...
      description: "Beachfront spot on The Strand.", // Reverting to safe Unsplash URL to fix the build error
    ...
    {
      name: "🍔 The Courtyard",
      description: "Cool, casual burgers & cocktails.", // Reverting to safe Unsplash URL to fix the build error
      image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&auto=format&fit-crop",
      query: "Tell me about The Courtyard in Townsville.",
    },
    {
      name: "🍨 Juliette's Gelateria",
      description: "Local favourite for dessert & coffee.", // Reverting to safe Unsplash URL to fix the build error
    ...
    },
    {
      ...
      description: "Townsville's original artisan café.", // Reverting to safe Unsplash URL to fix the build error
