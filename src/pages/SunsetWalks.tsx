...
const SunsetWalks = () => (
  <div className="container mx-auto px-4 py-8 max-w-4xl animate-fade-in">
    ...
    <img src="/sunset-walks-guide.webp" alt="Sunset walk at the Breakwater" className="rounded-xl shadow-lg w-full h-[400px] md:h-[500px] object-cover object-bottom mb-8" />
